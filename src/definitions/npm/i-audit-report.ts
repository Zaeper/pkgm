export enum EAuditVulnerabilitySeverity {
    HIGH = "high",
    MEDIUM = "medium",
    LOW = "low",
    NONE = "none"
...
export interface IAuditReport {
    ...
    "metadata": {
        "vulnerabilities": {
            ...
            "prod": number, "dev": number, "optional": number, "peer": number, "peerOptional": number, "total": number
        }
    }
}