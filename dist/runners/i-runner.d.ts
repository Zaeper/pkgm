...
export interface IRunner<U, V, W> {
    run: (configs: IConfigFile, fn: U, mode: EMode, workspacesIncludeMode: EIncludeMode, silent: boolean, printTargetProjects: boolean, runnerOptions: W, npmPackageScopes: INpmPackageScopes, isInitializing?: boolean) => Promise<V>;
}
